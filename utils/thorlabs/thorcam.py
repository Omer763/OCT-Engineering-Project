...
THORCAM_PATH = os.path.join(BASE_DIR, "dlls", "ThorCam")

# print("DLLs in THORCAM_PATH:", os.listdir(THORCAM_PATH))

# Make sure Windows will search this folder for native DLLs
os.environ["PATH"] = THORCAM_PATH + os.pathsep + os.environ.get("PATH", "")

try:
    os.add_dll_directory(THORCAM_PATH)
except (AttributeError, FileNotFoundError):
    # Older Python or weird environment – PATH should still help
    pass
...
print("ThorCam successfully imported.")
